...
int main(){
    ...
    while(cin >> leng >> name){
      ...
      while(cin >> play1){
        if(play1 == "-" || play1 == "."){
          printf("Game #%d:\n",x++);
          if(score1 == 1) cout << player1 << ": " << score1 << " point" << endl;
          else cout << player1 << ": " << score1 << " points" << endl;
          if(score2 == 1) cout << player2 << ": " << score2 << " point" << endl;
          else cout << player2 << ": " << score2 << " points" << endl;
